...
export default function MintPage() {
    ...
    useEffect(() => {
        if (imgURL || caption) {
            setImageCaption(caption ? caption : "Congratulations! You are in Eco-Friendly Zone! 🌱")
                            ...
                            <div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                                ...
                                <div className='flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t'>
                                    <h3 className='text-3xl font-semibold'>
                                        ...
                                        {loggedInUser && !isMinted && 'ResolvePlanet NFT'}
                                        {isMinted && 'Minted!'}
                                    </h3>
                                    <button
                                ...
                                <div className='relative p-6 flex-auto'>
                                    ...
                                    <p className='overflow-clip'>
                                        {!loggedInUser && !isMinted && 'You need to Login with Deso Identity to mint this NFT!'}
                                        {loggedInUser && !isMinted && 'Your are about to mint this NFT with your Deso Address:'}
                                        {loggedInUser && !isMinted && <span className='text-sm px-2 py-1 bg-gray-200 rounded-lg'>{loggedInUser}</span>}

                                        {isMinted && 'Your NFT has been minted!'}
                                    </p>
                                    ...
                                    <div className='flex justify-center mt-7'>
                                        ...
                                        {isMinted && <a className='text-blue-500 underline '
                                            ...
                                            target="_blank">View Minted NFT on DeSo</a>}
